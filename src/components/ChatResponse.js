...
const ChatResponse = ({ chat }) => {
  const tileClass =
    "inline-flex items-center justify-center p-5 mx-4 text-base font-medium text-gray-400 rounded-lg bg-gray-800 hover:bg-gray-700 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white";
